...
| `fix_unknown` | Re-normalize documents with $UNKNOWN$ values | `--dry_run` (optional) |
| `reclassify_unknown` | Re-classify PDFs with $UNKNOWN$ (full pipeline) | `--dry_run` (optional) |
