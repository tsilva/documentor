...
def load_issuing_parties():
    ...
    # Fallback list if env var not set or directory doesn't exist
    fallback_parties = [
        "$UNKNOWN$", "ActivoBank", "Insurance Provider", "Amazon", "Anthropic", "Antonio Martins & Filhos",
        ...
        "PRISMXR", "Example Company, Unipessoal Lda.", "Quindi", "Redunicre",
        ...
        "Finance Desk", "EMPLOYEE_TWO", "Example Vendor", "Together.ai", "TopazLabs", "Universal",
        "Universo", "$UNKNOWN$", "Vanguard", "Shared Toll", "VIDRIO PAIS PORTUGAL",
        "VITALOPE", "Utility Provider", "WisdomTree", "Worten", "xAI"
    ]
