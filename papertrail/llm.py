...
def get_system_prompt_raw_extraction(pre_extracted: dict[str, Any] | None = None) -> str:
    ...
    prompt = (
        ...
        "\n\n"
        "For document_title, extract the FULL document title or heading as it appears on the document, verbatim. "
        "Include dates, billing periods, reference numbers - everything in the title. "
        "Examples: 'Detalhe da Fatura de Abril 2024', 'Final Invoice for the August 2025 Billing Period'. "
        "If no clear title/heading is visible, leave it null. "
        "\n\n"
