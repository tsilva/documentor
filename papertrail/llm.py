...
def get_system_prompt_raw_extraction(pre_extracted: dict[str, Any] | None = None) -> str:
    ...
    prompt = (
        ...
        "- Portuguese NIF (e.g., ISSUER-TAX-ID)\n"
        "- EU VAT numbers (e.g., TESTOWNER for DE, TESTOWNER01 for FR)\n"
        "- US EIN (e.g., 12-3456789)\n"
        "Extract the raw number WITHOUT country prefix. If no tax ID is visible, leave it null.\n"
        "\n"
